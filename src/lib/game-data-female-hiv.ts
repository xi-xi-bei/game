...
export const femaleHivData: PerspectiveData = {
  ...
  title: '女性育龄视角 · 艾滋病',
  subtitle: '直面恐惧，科学守护',
  description: '你是一位育龄女性，高危接触后感染了艾滋病。在恐惧与希望之间，你的每一个选择都将决定自己和宝宝的命运。艾滋病不等于人生终结——U=U、母婴阻断成功率超98%，配偶知情且合理防护下可安全婚育，科学防治让你一样可以拥抱幸福。',
  protagonistName: '小琳',
  protagonistAge: 27,
  ...
  nodes: {
    ...
    fh_high_risk: {
      ...
      sceneTitle: '那个深夜',
      narrative:
        '闺蜜拉你出去聚会散心，你认识了一个叫阿凯的男生。聊得很投机，后来你们发生了无保护高危接触。\n\n第二天醒来，你才意识到自己完全不了解这个人的健康状况。一种从未有过的不安涌上心头。',
      choices: [
        {
          id: 'fh_hr_1',
      ...
      choices: [
        {
          ...
          knowledge: {
            title: 'HIV女性安全备孕完整方案',
            content:
              'HIV阳性女性安全备孕的科学步骤：\n\n📋 孕前准备：\n• 规范抗病毒治疗，病毒载量持续检测不到\n• CD4细胞计数正常\n• 评估目前用药是否适合孕期（部分药物需调整）\n\n📋 备孕方式：\n• 在医生指导下，选择排卵期自然受孕\n• 确保病毒载量检测不到，传染风险极低\n• 也可选择辅助生殖技术\n\n📋 孕期管理：\n• 继续抗病毒治疗（使用孕期安全药物）\n• 每月监测病毒载量\n• 孕晚期加强监测\n\n📋 分娩与产后：\n• 根据病毒控制情况、母婴情况，由医生评估选择分娩时机和分娩方式\n• 新生儿出生后6小时内开始预防性用药\n• 使用配方奶喂养（杜绝母乳喂养和混合喂养）\n• 新生儿定期随访至18月龄确认感染状态\n\n✅ 规范操作下，你完全有能力生育健康宝宝！',
            type: 'correct',
          },
