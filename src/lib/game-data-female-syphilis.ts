...
export const femaleSyphilisData: PerspectiveData = {
  ...
  title: '女性育龄视角 · 梅毒',
  subtitle: '夫妻同治，守护家庭',
  description: '你是一位育龄女性，高危接触后感染了梅毒。梅毒早期规范治疗可接近100%治愈，但前提是你要检查、要告知、要夫妻同治。你的每一个选择，都关乎伴侣的健康和宝宝的未来。',
  protagonistName: '小琳',
  protagonistAge: 27,
  ...
  nodes: {
    ...
    fs_prenatal_hide: {
      ...
      knowledge: {
        ...
        content:
          '女性隐瞒梅毒的最惨痛后果：\n\n💔 阿杰被感染——你传给他的\n💔 孕期梅毒→先天梅毒风险极高\n💔 流产率约20%、死胎率约10%\n💔 信任崩塌→婚姻危机\n\n💡 这一切只需一次坦诚就可以避免。梅毒早期规范治疗可接近100%治愈，但前提是你要检查、要告知、要同治。',
        type: 'danger',
      },
      choices: [
        {
