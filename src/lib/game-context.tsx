  ...
  const getEndingDetail = useCallback(() => {
    ...
    if (disease === 'hiv') {
      knowledgeSummary.push(
        ...
        '根据病毒控制情况和母婴情况，医生会建议选择合适的分娩时机和分娩方式',
        'HIV阳性妈妈建议人工喂养，避免母乳喂养，杜绝混合喂养',
        '我国法律明确保护HIV感染者的婚育权利，不禁止婚育',
        '隐瞒HIV感染违反《艾滋病防治条例》和《民法典》，可被申请撤销婚姻',
        'U=U不是口号，是WHO确认的科学事实——检测不到=不传染',
        'HIV阳性妈妈所生新生儿需在出生后6周和3个月做早期诊断，随访至18月龄',
      );
      ...
      knowledgeSummary.push(
        ...
        '新生儿出生6-12小时内接种乙肝免疫球蛋白+首剂疫苗，是母婴阻断关键',
        '乙肝妈妈可以母乳喂养（新生儿完成免疫接种后）',
        '乙肝妈妈所生新生儿完成3剂疫苗后1-2个月需查乙肝五项，确认免疫效果',
        '隐瞒乙肝病情违反《民法典》，可被申请撤销婚姻',
        '日常吃饭、握手、拥抱不会传播乙肝',
      );
    } else if (disease === 'syphilis') {
      knowledgeSummary.push(
        '梅毒早期规范治疗可接近100%治愈，苄星青霉素是特效药',
        '无症状携带是最常见的家庭传染源，主动筛查至关重要',
        '梅毒治疗必须夫妻同治，否则会造成"乒乓感染"',
        '孕期梅毒治疗应在分娩前一个月完成，确保充分阻断',
        '先天梅毒对新生儿危害极大，孕期筛查可及早发现',
        '梅毒妈妈所生新生儿需每3个月随访RPR检测直至转阴',
