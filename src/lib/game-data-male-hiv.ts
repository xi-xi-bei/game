...
export const maleHivData: PerspectiveData = {
  ...
  nodes: {
    ...
    mh_high_risk: {
      ...
      sceneTitle: '出差那晚',
      narrative:
        '公司团建的最后一晚，你发生了无保护高危接触。\n\n第二天醒来，你对着镜子里的自己说——"就这一次，不会那么倒霉的。"\n\n但你的心里有一个声音在说：你确定吗？',
      choices: [
        {
          id: 'mh_hr_1',
    ...
    mh_test_positive: {
      ...
      sceneTitle: '检测结果',
      narrative:
        '6周后，你做了检测。\n\nHIV抗体阳性。\n\n你的世界仿佛塌了。明明吃了阻断药……\n\n医生说："阻断药成功率很高但不是100%，可能服药时间不够早。但请你听好——HIV感染不等于死刑。规范抗病毒治疗后，你可以正常生活、正常工作、正常婚育（配偶知情且合理防护下）。"\n\n你唯一想的是——小雅怎么办？',
      knowledge: {
